...
_1787: (x0,x1,x2,x3) => x0.addEventListener(x1,x2,x3),
_1788: (x0,x1,x2,x3) => x0.removeEventListener(x1,x2,x3),
_1794: () => new XMLHttpRequest(),
_1795: (x0,x1,x2) => x0.setRequestHeader(x1,x2),
_1797: x0 => x0.getAllResponseHeaders(),
_1814: (s, m) => {
          try {
...
_1901: (o, p) => o[p],
_1955: (x0,x1) => x0.withCredentials = x1,
_1957: x0 => x0.responseURL,
_1958: x0 => x0.status,
